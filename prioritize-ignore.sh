...
curl --request POST $WS_URL'/api/v1.3' -H 'Content-Type: application/json'  -d '{ "requestType" : "ignoreAlerts", "userKey" : "'$WS_USERKEY'", "projectToken" : "'$REPOTOKEN'", "alertUuids" : "['$IGNORES']", "comments" : "green shield vulnerabilities are not reachable or exploitable and have been ignored"}'
